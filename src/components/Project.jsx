  ...
  return project ? (
    <div className="Project Card">
      ...
      <section className="Card__Content">
        <p><strong style={{ textTransform: 'capitalize' }}>{project.cause}</strong> project managed by <strong>{project.manager}</strong>{project.institution && (<> at <strong>{project.institution}</strong></>)}. {project.url &&
          <a
            href={project.url}
            target="_blank"
